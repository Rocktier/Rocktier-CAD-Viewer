...
//! Table data generated from ezdxf (MIT) `DXF_DEFAULT_COLORS`, see THIRD_PARTY_NOTICES.
...
/// Resolves an ACI index (1..=255) to RGB. Index 7 ("auto") is handled by callers.
pub fn aci_to_rgb(index: u8) -> (u8, u8, u8) {
    let v = ACI[index as usize];
